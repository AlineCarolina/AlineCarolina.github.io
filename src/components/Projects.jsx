          ...
          <li>
            <a href='https://github.com/AlineCarolina/Blogs-API' target='_blank' rel='noreferrer'>
              <div className='div-img-h3'>
                ...
                <img src="https://picsum.photos/id/1/100/100" alt="Imagem do Projeto 1" className='img-project' />
              </div>
              <p>
          ...
          <li>
            <a href='https://github.com/AlineCarolina/Trybesmith' target='_blank' rel='noreferrer'>
              <div className='div-img-h3'>
                ...
                <img src="https://picsum.photos/id/2/100/100" alt="Imagem do Projeto 2" className='img-project' />
              </div>
              <p>
          ...
          <li>
            <a href='https://github.com/AlineCarolina/StarWars' target='_blank' rel='noreferrer'>
              <div className='div-img-h3'>
                ...
                <img src="https://picsum.photos/id/1/100/100" alt="Imagem do Projeto 3" className='img-project' />
              </div>
              <p>
